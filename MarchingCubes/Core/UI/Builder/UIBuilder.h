...
public:
    ...
    virtual void Image(void* textureHandle, const UI::Vector2& size) = 0;
    ...
    virtual UI::Vector2 GetMousePos() = 0;
    virtual void SetCursorScreenPos(const UI::Vector2& pos) = 0;
    ...
    virtual void InvisibleButton(const char* str_id, const UI::Vector2& size) = 0;
